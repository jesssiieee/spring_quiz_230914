		...
		<div class="contents d-flex">
			...
			<nav class="col-2">
				...
				<ul class="nav flex-column mt-4">
					<li class="nav-item">
						<a href="http://localhost:8080/weather_history/weather-list-view" class="nav-link menu-font">날씨</a>
					</li>
					<li class="nav-item">
						<a href="http://localhost:8080/weather_history/add-weather-view" class="nav-link menu-font">날씨입력</a>
					</li>
					<li class="nav-item">
